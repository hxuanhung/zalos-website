        ...
        <footer className="w-full py-6 flex flex-col items-center justify-center text-gray-400 text-sm bg-transparent z-20">
          <div className="flex items-center gap-2 mb-2">
            <span>
              ...
              reserved. Zalos Limited is a private limited company incorporated
              in England and Wales with company registration number 16202720
              (TBD).
            </span>
          </div>
